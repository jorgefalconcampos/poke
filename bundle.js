...
// var readlineSync = require('readline-sync'); //Para I/O
...
// P.resource('/api/v2/pokemon/'+pokeID)
...
function searchByName(poke) {
  ...
  //  P.getBerryByName(poke) //Calling the getBerryByName method
  //  .then(function(response) { 
  //    console.log(response);
  //    search["query_result"].value=JSON.stringify(response); //Adjusting the query result to a readeable text and displaying it to a textarea 
  //    console.log('Pokemon info loaded succesfully'); 
  //  })
  //  .catch(function(error) {
  //    console.log('There was an error while retrieving data from pokemon: ', error);
  ...
  //  P.getBerryByName(poke).then( function(response) { /* bla bla bla */ } ).catch( function(error) { /* error */ } );
  //Promises works with only 1 valid result, either good or bad. Can't be both.
...
// //Asking pokemon ID to user
// var pokeID = readlineSync.questionInt('Escribe el ID del pokemon: ');
// console.log('Elegiste el pokemon con ID #' + pokeID + ', mostrando su información... \n');
  


// P.getBerryByName(pokeID)
// .then(function(response) {
//   console.log(response);
// })
// .catch(function(error) {
...
// //Asking pokemon name to user
// var pokeName = readlineSync.question('Escribe el nombre del pokemon: ');
// console.log('Elegiste el pokemon con nombre <<' + pokeName + '>>, mostrando su información... \n');
  
// P.getBerryByName(pokeName)
// .then(function(response) {
//   console.log(response);
// })
// .catch(function(error) {
